...
$modelLabel = new \backend\models\Announcement();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'announcement-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('announcement/index')]); ?>     
            ...
            <?php 
              ...
              echo '<th class="sorting" tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('title').'</th>';
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "announcement-form", "class"=>"form-horizontal", "action"=>Url::toRoute("announcement/save")]); ?>                      
                 <input type="hidden" class="form-control" id="id" name="Announcement[id]" />
                 <!-- 
          ...
          <div id="title_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" name="Announcement[title]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="sort_order_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="sort_order" name="Announcement[sort_order]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="content_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <!-- <input type="text" class="form-control" id="content" name="Announcement[content]" placeholder="必填" /> -->
                  <textarea class="form-control" id="content" name="Announcement[content]" placeholder="必填" > </textarea>
              </div>
              <div class="clearfix"></div>
          </div>
...
<!-- <body></body>后代码块 -->
 ...
 function searchAction(){
		$('#announcement-search-form').submit();
	}
...
function initModel(id, type, fun){
	...
	$.ajax({
		   type: "GET",
		   url: "<?=Url::toRoute('announcement/view')?>",
		   data: {"id":id},
		   cache: false,
		   dataType:"json",
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('announcement/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#announcement-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('announcement/create')?>" : "<?=Url::toRoute('announcement/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
