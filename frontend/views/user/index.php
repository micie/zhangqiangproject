  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-header"><h3 class="box-title">层级： 
        <?php
          if($top_user_id > 0 ){
            foreach ($path_show as  $value) {
              echo '<a   href="'.Url::toRoute(['user/index','top_user_id'=>$value['user_id']]).'"> '.$value['full_name'].'</a> -- ';
            }
          }
        ?>
         </h3> 
            ...
            <div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'User-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('user/index')]); ?>     
                  ...
                  <div class="form-group" style="margin: 5px;">
                      <label>搜索:</label>
                      <input type="text" class="form-control" id="query[keyword]" name="query[keyword]"  value="<?=isset($query["keyword"]) ? $query["keyword"] : "" ?>" placeholder="搜索手机号或者姓名">
                  </div>
